...
package uiether.components.supportClasses
{
    ...
    import uiether.components.Button;
    import uiether.core.UIComponent;
    import uiether.events.TrackBaseEvent;
    
    [Event(name="thumbDrag", type="uiether.events.TrackBaseEvent")]
    [Event(name="thumbPress", type="uiether.events.TrackBaseEvent")]
    [Event(name="thumbRelease", type="uiether.events.TrackBaseEvent")]
    /**
    ...
    public class TrackBase extends Range
    {
        ...
        private function mouseDownHandler(event:MouseEvent):void
        {
            if (event.target == track) {
                _position = pointToLinearPosition(new Point(event.localX, event.localY));
                _value = pointToValue(_position.x, _position.y);
        ...
        {
            _position = pointToLinearPosition(track.globalToLocal(new Point(event.stageX, event.stageY)));
            _value = pointToValue(_position.x, _position.y);
